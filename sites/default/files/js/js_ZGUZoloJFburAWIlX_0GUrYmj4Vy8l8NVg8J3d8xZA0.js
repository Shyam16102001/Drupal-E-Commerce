...
function updateQuantity(input) {
  ...
  totalPriceElement.textContent = (quantity * price).toFixed(2); // Keep only two decimal places
...
function updateTotalCost() {
  ...
  totalCostElement.textContent = totalCost.toFixed(2); // Keep only two decimal places
}
  
function editQunatity(productId){
