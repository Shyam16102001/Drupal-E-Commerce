...
document.addEventListener("DOMContentLoaded", function () {
  ...
  deliveryOptions.forEach(function (option) {
    option.addEventListener("click", function () {
      // Reset all delivery options to inactive
      deliveryOptions.forEach(function (option) {
      ...
      // Update the delivery price based on the selected method
      ...
      var deliveryCost = parseFloat(
        deliveryCostElement.textContent.replace(/[^0-9.]/g, "")
      );
      var newTotal = subtotal + deliveryCost;
      totalElement.textContent = "₹" + newTotal.toFixed(2);

      // Disable the pay now button if the subtotal is greater than the balance
      if (subtotal > balance) {
